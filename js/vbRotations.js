...
monkeysppp.vbRotations.SVGMaker = function() {
    ...
    function drawTutorialButton() {
        ...
        _this.tutorialButton.click(function() {
            errorHandler("foo");
            drawTutorial(0);
        });
    }
    ...
    function move(players, time) {
        ...
        _this.setter.animate({ transform: 'translate(' + players.p.x + ', ' + players.p.y + ')' }, time, null, donemove);
        _this.oppo.animate({ transform: 'translate(' + players.o.x + ', ' + players.o.y + ')' }, time, null, donemove);
        _this.m1.animate({ transform: 'translate(' + players.c2.x + ', ' + players.c2.y + ')' }, time, null, donemove);
        _this.m2.animate({ transform: 'translate(' + players.c1.x + ', ' + players.c1.y + ')' }, time, null, donemove);
        _this.h1.animate({ transform: 'translate(' + players.s1.x + ', ' + players.s1.y + ')' }, time, null, donemove);
        _this.h2.animate({ transform: 'translate(' + players.s2.x + ', ' + players.s2.y + ')' }, time, null, donemove);
        return true;
    }
    //  function goback() {
